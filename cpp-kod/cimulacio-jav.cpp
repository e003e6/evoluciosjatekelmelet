...
const int N = 100;
const int GENERATION = 20;						// 1000 eredetileg!
const int ROUND = 10;

const int UPDATE_MODE = 2;						// 2 eredetileg!

const int MODE = 2;								// 1 eredetileg!
...
void display_payoff(double* payoff) {
	...
	for (n=0; n<N; n++) printf("player %d’s payoff = %f\n", n, payoff[n]);
}
